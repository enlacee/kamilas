...
$registros = $instancia->getPreconcepcion($_GET["id"]);

if(array_key_exists("guardar",$_POST)){
	
	$instancia->setPreconcepcion($_POST["titulo"],$_POST["detalle"],$_GET["id"]);
}
                            	...
                            	<tr>
                                    ...
                                    <td width="85%" class="text-left">
                                    	<span class="pdRight20 center-block">
                                        	<input type="text" name="titulo" id="titulo" class="form-control" value="<?php echo $registros[0]["titulo"]; ?>">
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                  ...
                                  <textarea class="form-control" name="detalle" id="editor"><?php echo $registros[0]["detalle"]; ?></textarea></td>
                                </tr>
                                <tr>
